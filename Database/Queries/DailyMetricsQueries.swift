...
public enum DailyMetricsQueries {
    ...
    public enum MetricType: String {
        ...
        case migrationScheduled = "migration_scheduled"
        case migrationStarted = "migration_started"
        case migrationCompleted = "migration_completed"
        case migrationFailed = "migration_failed"
        case migrationPostflightFailed = "migration_postflight_failed"
        case migrationInterrupted = "migration_interrupted"
        case migrationResumed = "migration_resumed"
        case migrationBlockedInsufficientDisk = "migration_blocked_insufficient_disk"
        case recoveryKeyGenerated = "recovery_key_generated"
        case recoveryKeyRestored = "recovery_key_restored"
        case encryptionPromptShown = "encryption_prompt_shown"
        case encryptionPromptCTA = "encryption_prompt_cta"
        case encryptionPromptSnoozed = "encryption_prompt_snoozed"
